...
def predict():
    ...
    progress_color = ''
    if prediction[0] in [0, 1]:
        progress_color = 'bg-success'  # Green
    elif prediction[0] in [2, 3]:
    ...
    if prediction[0] == 2:
            result = 'Your Stress test result : Moderate Stress (Kindly Take Depression Test)'
    if prediction[0] == 3:
            result = 'Your Stress test result : Moderately severe Stress (Kindly Take Depression Test)'
    if prediction[0] == 4:
            result = 'Your Stress test result : Severe Stress (Kindly Take Depression Test)'
    if prediction[0] ==5:
            result = 'Worse Case Depression'
